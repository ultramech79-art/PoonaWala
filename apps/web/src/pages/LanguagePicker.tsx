...
import { Globe, CheckCircle, Eye } from 'lucide-react'
  ...
  return (
    <div className="page animate-fade-in">
      ...
      <div className="flex flex-col items-center pt-12 pb-8 px-5">
        <div className="w-14 h-14 rounded-2xl bg-ink-900 flex items-center justify-center mb-5 shadow-card">
          <Eye className="w-7 h-7 text-gold-400" strokeWidth={2} />
        </div>
              ...
              <button
                ...
                className={clsx(
                  ...
                  lang.disabled
                    ...
                    : selected
                      ? 'bg-brand-50 border-brand-400 shadow-brand-sm'
                      : 'bg-white border-stone-200 hover:border-stone-300 hover:bg-stone-50 active:scale-[0.98]'
                )}
              >
                <div className="flex items-center gap-3">
                  <Globe className={clsx('w-5 h-5', selected ? 'text-brand-500' : 'text-stone-400')} />
